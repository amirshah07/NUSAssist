...
const MAJORS: Major[] = [
  ...
  { value: 'Business Artificial Intelligence Systems', label: 'Business Artificial Intelligence Systems' },
  ...
  { value: 'Environmental and Sustainability Engineering', label: 'Environmental and Sustainability Engineering' },
  ...
  { value: 'Infrastructure and Project Management', label: 'Infrastructure and Project Management' },
  ...
  { value: 'Robotics and Machine Intelligence', label: 'Robotics and Machine Intelligence' },
